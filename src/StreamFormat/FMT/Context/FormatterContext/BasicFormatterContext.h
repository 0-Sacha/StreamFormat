...
#include "StreamFormat/FMT/Buffer/FMTBufferOut/FMTBufferOut.h"
...
#include "FormatterTextPropertiesExecutor/FormatterTextPropertiesExecutor.h"
...
namespace StreamFormat::FMT::Context
{
    ...
    public:
        BasicFormatterContext(Detail::BasicBufferOutManager<CharBuffer>& BufferOutManager, Detail::IFormatterTextPropertiesExecutor<BufferOutType>& textPropertiesExecutor,
    ...
    public:
        ...
        inline void RunType(Type&& type, const Rest&&... rest)
        {
            RunType(type);
        ...
        template <typename Type, typename... Rest>
        inline void RunSubType(Type&& type, const Rest&&... rest)
        {
            RunSubType(type);
        ...
        {
            m_BufferOut.BasicWriteType(type);
        }

        template <typename Type, typename... Rest>
        inline void BasicRunSubType(Type&& type, const Rest&&... rest)
        {
        ...
        template <typename Type, typename... Rest>
        inline void WriteSubType(Type&& type, Rest&&... rest)
        {
        ...
        template <typename Type, typename... Rest>
        inline void BasicSubWriteType(Type&& type, Rest&&... rest)
        {
...
namespace StreamFormat::FMT::Context
{
    ...
    void BasicFormatterContext<CharFormat, CharBuffer>::SubContext(const Detail::BufferInProperties<NewCharFormat>& bufferInProperties, Args&&... args)
    {
        ...
        {
            Detail::IFormatterTextPropertiesExecutor<BufferOutType>& am_TextPropertiesExecutor =
                reinterpret_cast<Detail::IFormatterTextPropertiesExecutor<BufferOutType>&>(m_TextProperties.GetTextPropertiesExecutor());
