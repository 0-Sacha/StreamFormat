...
namespace EngineCore::TNX {
	...
	struct Matrix<2, 2, Type, TNXType::TNXBasic>
	{
		//----------------------------------//
		//------------- Values -------------//
		//----------------------------------//
		...
		using RowType		= Vector<2, Type, TNXType::TNXBasic>;
		...
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>& ComputeMultAsAddInPlace(const MatrixConvertibleTo<2, 2, ValueType> auto& mat);
		// Not sure for the name
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>  ComputeMultAsAdd(const MatrixConvertibleTo<2, 2, ValueType> auto& mat);

		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic> Transpose();

		constexpr ValueType Determinant();

		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic> Inverse();

		// Row, column
		static constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic> FromOuterProduct(const VectorConvertibleTo<2, ValueType> auto&& row0, const VectorConvertibleTo<2, ValueType> auto&& row1);
		...
		// operator +I
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>  operator+();
		// operator -I
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>  operator-();
		...
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>& operator--();
		// operator I++
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>  operator++(int);
		// operator I--
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>  operator--(int);


		// operator =
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>& operator=(const std::convertible_to<ValueType> auto scalar);
		constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic>& operator=(const MatrixConvertibleTo<2, 2, ValueType> auto& mat);
	...
	// operator +
	template<typename ValueType> constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic> operator+(const Matrix<2, 2, ValueType, TNXType::TNXBasic>& lhs, const std::convertible_to<ValueType> auto rhs);
	template<typename ValueType> constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic> operator+(const std::convertible_to<ValueType> auto lhs, const Matrix<2, 2, ValueType, TNXType::TNXBasic>& rhs);
	template<typename ValueType> constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic> operator+(const Matrix<2, 2, ValueType, TNXType::TNXBasic>& lhs, const MatrixConvertibleTo<2, 2, ValueType> auto& rhs);
	...
	// row in input
	template<typename ValueType> constexpr typename Matrix<2, 2, ValueType, TNXType::TNXBasic>::ColumnType operator*(const Matrix<2, 2, ValueType, TNXType::TNXBasic>& lhs, const VectorConvertibleTo<2, ValueType> auto& rhs);
	// column in input
	template<typename ValueType> constexpr typename Matrix<2, 2, ValueType, TNXType::TNXBasic>::RowType operator*(const VectorConvertibleTo<2, ValueType> auto& lhs, const Matrix<2, 2, ValueType, TNXType::TNXBasic>& rhs);
	// same
	template<typename ValueType> constexpr Matrix<2, 2, ValueType, TNXType::TNXBasic> operator*(const Matrix<2, 2, ValueType, TNXType::TNXBasic>& lhs, const MatrixConvertibleTo<2, 2, ValueType> auto& rhs);
	// others
	template<typename ValueType> constexpr Matrix<3, 2, ValueType, TNXType::TNXBasic> operator*(const Matrix<2, 2, ValueType, TNXType::TNXBasic>& lhs, const MatrixConvertibleTo<3, 2, ValueType> auto& rhs);
	template<typename ValueType> constexpr Matrix<4, 2, ValueType, TNXType::TNXBasic> operator*(const Matrix<2, 2, ValueType, TNXType::TNXBasic>& lhs, const MatrixConvertibleTo<4, 2, ValueType> auto& rhs);
