...
namespace EngineCore::TNX {
	...
	struct Vector<4, Type, TNXType::TNXBasic>
	{
		//----------------------------------//
		//------------- Values -------------//
		//----------------------------------//
		...
		constexpr Vector<4, ValueType, TNXType::TNXBasic> operator&&(const VectorConvertibleTo<4, ValueType> auto& rhs);
		constexpr Vector<4, ValueType, TNXType::TNXBasic> operator||(const VectorConvertibleTo<4, ValueType> auto& rhs);
		...
		// operator +I
		constexpr Vector<4, ValueType, TNXType::TNXBasic>  operator+() const;
		// operator -I
		constexpr Vector<4, ValueType, TNXType::TNXBasic>  operator-() const;
		// operator ~I
		constexpr Vector<4, ValueType, TNXType::TNXBasic>  operator~() const;
		...
		// operator ++I
		constexpr Vector<4, ValueType, TNXType::TNXBasic>& operator++();
		// operator --I
		constexpr Vector<4, ValueType, TNXType::TNXBasic>& operator--();
		// operator I++
		constexpr Vector<4, ValueType, TNXType::TNXBasic>  operator++(int);
		// operator I--
		constexpr Vector<4, ValueType, TNXType::TNXBasic>  operator--(int);

		// operator =
		constexpr Vector<4, ValueType, TNXType::TNXBasic>& operator=(const std::convertible_to<ValueType> auto scalar);
		constexpr Vector<4, ValueType, TNXType::TNXBasic>& operator=(const VectorConvertibleTo<4, ValueType> auto& vec);
	...
	// operator +
	template <typename ValueType> constexpr Vector<4, ValueType, TNXType::TNXBasic> operator+(const Vector<4, ValueType, TNXType::TNXBasic>& lhs, const std::convertible_to<ValueType> auto rhs);
	template <typename ValueType> constexpr Vector<4, ValueType, TNXType::TNXBasic> operator+(const std::convertible_to<ValueType> auto lhs, const Vector<4, ValueType, TNXType::TNXBasic>& rhs);
	template <typename ValueType> constexpr Vector<4, ValueType, TNXType::TNXBasic> operator+(const Vector<4, ValueType, TNXType::TNXBasic>& lhs, const VectorConvertibleTo<4, ValueType> auto& rhs);
