...
#define ENGINECORE_TESTINTERNAL_SUITE_EXTRA(...)							EngineCore::Tests::Detail::TestSuite::ExtraData{ __VA_ARGS__ }

//-------------------- TestSuite --------------------//
#define ECT_TEST_SUITE(TestSuiteName, ...)		EngineCore::Tests::Detail::TestSuite ENGINECORE_TESTINTERNAL_SUITE_NAME(TestSuiteName)(#TestSuiteName, ENGINECORE_TESTINTERNAL_SUITE_EXTRA(__VA_ARGS__))
