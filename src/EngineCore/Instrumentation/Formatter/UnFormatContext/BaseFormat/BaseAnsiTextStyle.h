...
namespace EngineCore::Instrumentation::Fmt {
	...
	struct UnFormatType<Detail::ForwardAsAnsiBasicTextStyle, UnFormatContext>
	{
		static bool Read(const Detail::ForwardAsAnsiBasicTextStyle& t, UnFormatContext& context) {
			...
			return context.BasicReadType('\033', '[', static_cast<std::uint8_t>(t), 'm');
		}
	};
	...
	struct UnFormatType<Detail::AnsiTFSIntensity, UnFormatContext>
	{
		static bool Read(const Detail::AnsiTFSIntensity& t, UnFormatContext& context) {
			...
			return UnFormatType<Detail::ForwardAsAnsiBasicTextStyle, UnFormatContext>::Read(static_cast<Detail::ForwardAsAnsiBasicTextStyle>(t), context);
		}
	};
	...
	struct UnFormatType<Detail::AnsiBasicTextStyle, UnFormatContext>
	{
		static bool Read(const Detail::AnsiBasicTextStyle& t, UnFormatContext& context) {
			...
			case Detail::AnsiBasicTextStyle::Intensity_Normal:
				return UnFormatType<Detail::AnsiTFSIntensity, UnFormatContext>::Read(static_cast<Detail::AnsiTFSIntensity>(t), context);
				break;

			case Detail::AnsiBasicTextStyle::Italic_Enable:
			case Detail::AnsiBasicTextStyle::Italic_Disable:
				return UnFormatType<Detail::AnsiTFSItalic, UnFormatContext>::Read(static_cast<Detail::AnsiTFSItalic>(t), context);
				break;
			...
			case Detail::AnsiBasicTextStyle::Underline_Disable:
				return UnFormatType<Detail::AnsiTFSUnderline, UnFormatContext>::Read(static_cast<Detail::AnsiTFSUnderline>(t), context);
				break;
			...
			case Detail::AnsiBasicTextStyle::Blink_Disable:
				return UnFormatType<Detail::AnsiTFSBlink, UnFormatContext>::Read(static_cast<Detail::AnsiTFSBlink>(t), context);
				break;

			case Detail::AnsiBasicTextStyle::Inverted_Enable:
			case Detail::AnsiBasicTextStyle::Inverted_Disable:
				return UnFormatType<Detail::AnsiTFSInverted, UnFormatContext>::Read(static_cast<Detail::AnsiTFSInverted>(t), context);
				break;
			...
			case Detail::AnsiBasicTextStyle::Ideogram_AllDisable:
				return UnFormatType<Detail::AnsiTFSIdeogram, UnFormatContext>::Read(static_cast<Detail::AnsiTFSIdeogram>(t), context);
				break;
			...
			case Detail::AnsiBasicTextStyle::Script_AllDisable:
				return UnFormatType<Detail::AnsiTFSScript, UnFormatContext>::Read(static_cast<Detail::AnsiTFSScript>(t), context);
				break;
			}
		}
	};
