...
namespace EngineCore::TestCore {
	...
	public:
		static inline EngineCore::LogSystem& GetLogger()			{ return GetInstance().Logger; }
...
namespace EngineCore::Fmt {
	...
	struct FormatType<EngineCore::TestCore::TestSuite, FormatContext>
	{
		static void Write(const EngineCore::TestCore::TestSuite& t, FormatContext& context) {
			context.Print(t.Name);
		}
	};

	template<typename FormatContext>
	struct FormatType<EngineCore::TestCore::TestSuite::TestFunc, FormatContext>
	{
		static void Write(const EngineCore::TestCore::TestSuite::TestFunc& t, FormatContext& context) {
