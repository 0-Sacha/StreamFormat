...
#include "EngineCore/EngineCompute/Detail/EngineComputeType.h"
...
namespace EngineCore::EngineCompute {
	template <std::size_t COUNT, typename Type, typename ComputeAlgorithm = Detail::EngineComputeType::EngineComputeDefault>
	struct Vector;
...
struct EngineCore::Instrumentation::Fmt::FormatType<EngineCore::EngineCompute::Vector<COUNT, Type, ComputeAlgorithm>, FormatContext>
{
...
struct EngineCore::Instrumentation::Fmt::UnFormatType<EngineCore::EngineCompute::Vector<COUNT, Type, ComputeAlgorithm>, UnFormatContext>
{
