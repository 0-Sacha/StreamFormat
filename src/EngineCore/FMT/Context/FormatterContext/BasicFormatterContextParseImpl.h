...
namespace EngineCore::FMT::Context {
	...
	void BasicFormatterContext<CharFormat, CharBuffer, ContextArgs...>::ParseTimer() {
			ParseFormatData();
	...
	template<typename CharFormat, typename CharBuffer, typename ...ContextArgs>
	void BasicFormatterContext<CharFormat, CharBuffer, ContextArgs...>::ParseDate() {
			ParseFormatData();
	...
	template<typename CharFormat, typename CharBuffer, typename ...ContextArgs>
	void BasicFormatterContext<CharFormat, CharBuffer, ContextArgs...>::ParseSetter() {
			ParseFormatData();
