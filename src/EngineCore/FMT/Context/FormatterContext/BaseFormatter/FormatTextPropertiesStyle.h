...
namespace EngineCore::FMT {
	...
	{
		static void Format(const Detail::TextProperties::Reset t, FormatterContext& context) {
	...
	struct FormatterType<Detail::TextProperties::TextStyle::BasicStyle, FormatterContext>
	{
		static void Format(const Detail::TextProperties::TextStyle::BasicStyle t, FormatterContext& context) {
			...
			case Detail::TextProperties::TextStyle::BasicStyle::Intensity_Normal:
				FormatterType<Detail::TextProperties::TextStyle::Intensity, FormatterContext>::Format(static_cast<Detail::TextProperties::TextStyle::Intensity>(t), context);
				break;
			...
			case Detail::TextProperties::TextStyle::BasicStyle::Italic_Disable:
				FormatterType<Detail::TextProperties::TextStyle::Italic, FormatterContext>::Format(static_cast<Detail::TextProperties::TextStyle::Italic>(t), context);
				break;
			...
			case Detail::TextProperties::TextStyle::BasicStyle::Underline_Disable:
				FormatterType<Detail::TextProperties::TextStyle::Underline, FormatterContext>::Format(static_cast<Detail::TextProperties::TextStyle::Underline>(t), context);
				break;
			...
			case Detail::TextProperties::TextStyle::BasicStyle::Blink_Disable:
				FormatterType<Detail::TextProperties::TextStyle::Blink, FormatterContext>::Format(static_cast<Detail::TextProperties::TextStyle::Blink>(t), context);
				break;
			...
			case Detail::TextProperties::TextStyle::BasicStyle::Inverted_Disable:
				FormatterType<Detail::TextProperties::TextStyle::Inverted, FormatterContext>::Format(static_cast<Detail::TextProperties::TextStyle::Inverted>(t), context);
				break;
			...
			case Detail::TextProperties::TextStyle::BasicStyle::Ideogram_AllDisable:
				FormatterType<Detail::TextProperties::TextStyle::Ideogram, FormatterContext>::Format(static_cast<Detail::TextProperties::TextStyle::Ideogram>(t), context);
				break;
			...
			case Detail::TextProperties::TextStyle::BasicStyle::Script_AllDisable:
				FormatterType<Detail::TextProperties::TextStyle::Script, FormatterContext>::Format(static_cast<Detail::TextProperties::TextStyle::Script>(t), context);
				break;
			default:
				break;
			}
