...
#define ENGINECORE_TESTSUITE_SUITE_EXTRA(...)	EngineCore::Test::TestSuite::TestSuiteExtra{ __VA_ARGS__ }
#define ENGINECORE_TESTSUITE_FUNC_EXTRA(...)	EngineCore::Test::TestSuite::TestFuncExtra{ __VA_ARGS__ }


//-------------------- TestSuite --------------------//

#define ENGINECORE_TESTSUITE_TEST_SUITE(TestSuiteName, ...)	EngineCore::Test::TestSuite ENGINECORE_TESTSUITE_SUITE_NAME(TestSuiteName)(#TestSuiteName, ENGINECORE_TESTSUITE_SUITE_EXTRA(__VA_ARGS__))


//-------------------- TestFunc --------------------//

#define ENGINECORE_TESTSUITE_FUNC_DECLARE_EXEC(TestSuiteName, TestName)		void ENGINECORE_TESTSUITE_FUNC_EXEC_NAME(TestSuiteName, TestName)(EngineCore::Test::TestSuite::TestFunc &TestFuncLink);
#define ENGINECORE_TESTSUITE_FUNC_CREATE(TestSuiteName, TestName, ...)		volatile EngineCore::Test::TestSuite::TestFunc ENGINECORE_TESTSUITE_FUNC_NAME(TestSuiteName, TestName)(#TestName, ENGINECORE_TESTSUITE_SUITE_NAME(TestSuiteName), ENGINECORE_TESTSUITE_FUNC_EXEC_NAME(TestSuiteName, TestName), ENGINECORE_TESTSUITE_FUNC_EXTRA(__VA_ARGS__))
...
#define ENGINECORE_TESTSUITE_TEST_FUNC(TestSuiteName, TestName)	ENGINECORE_TESTSUITE_FUNC_DECLARE_EXEC(TestSuiteName, TestName) \
																	...
																	void ENGINECORE_TESTSUITE_FUNC_EXEC_NAME(TestSuiteName, TestName)(EngineCore::Test::TestSuite::TestFunc &TestFuncLink)
