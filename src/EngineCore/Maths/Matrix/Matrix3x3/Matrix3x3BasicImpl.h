...
namespace EngineCore {
	...
	struct Matrix<3, 3, Type, EngineCompute::EngineComputeBasic>
	{
		//----------------------------------//
		//------------- Values -------------//
		//----------------------------------//
		...
		// operator +I
		constexpr Matrix<3, 3, ValueType, EngineCompute::EngineComputeBasic>  operator+();
		// operator -I
		constexpr Matrix<3, 3, ValueType, EngineCompute::EngineComputeBasic>  operator-();
		...
		constexpr Matrix<3, 3, ValueType, EngineCompute::EngineComputeBasic>& operator--();
		// operator I++
		constexpr Matrix<3, 3, ValueType, EngineCompute::EngineComputeBasic>  operator++(int);
		// operator I--
		constexpr Matrix<3, 3, ValueType, EngineCompute::EngineComputeBasic>  operator--(int);
