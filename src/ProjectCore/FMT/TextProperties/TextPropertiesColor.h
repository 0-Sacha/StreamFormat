...
namespace ProjectCore::FMT::Detail
{
    ...
    public:
        ...
        bool NeedModif(const TextProperties::TextColor::BasicColor& given) {
        ...
        bool NeedModif(const TextProperties::TextColor::ColorCube& given) {
            return NeedModif(given.Fg) || NeedModif(given.Bg);
        }
        ...
        bool NeedModif(const TextProperties::TextColor::Color24b& given) {
            return NeedModif(given.Fg) || NeedModif(given.Bg);
        }
    };
