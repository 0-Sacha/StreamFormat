...
namespace ProjectCore::FMT::Detail
{
    ...
    public:
        ...
        static BaseColorCube MakeGrayscaleColor255(const std::uint8_t value) { return MakeGrayscaleColor24(static_cast<std::uint8_t>(static_cast<float>(value) / 255) * 24); }
    ...
    {
    public:
        constexpr explicit ColorCubeFG()
            : TextProperties::TextColor::BaseColorCube()
        {}
        constexpr explicit ColorCubeFG(const std::uint8_t color)
            : TextProperties::TextColor::BaseColorCube(color)
        {}
        constexpr ColorCubeFG(const TextProperties::TextColor::BaseColorCube& color)
            : TextProperties::TextColor::BaseColorCube(color)
        {}

    public:
        static ColorCubeFG MakeNormalColor(const std::uint8_t value) { return static_cast<ColorCubeFG>(TextProperties::TextColor::BaseColorCube::MakeNormalColor(value)); }

        static ColorCubeFG MakeBrightColor(const std::uint8_t value) { return static_cast<ColorCubeFG>(TextProperties::TextColor::BaseColorCube::MakeBrightColor(value)); }
    ...
    {
        constexpr explicit ColorCubeBG()
            : TextProperties::TextColor::BaseColorCube()
        {}
        constexpr explicit ColorCubeBG(const std::uint8_t color)
            : TextProperties::TextColor::BaseColorCube(color)
        {}
        constexpr ColorCubeBG(const TextProperties::TextColor::BaseColorCube& color)
            : TextProperties::TextColor::BaseColorCube(color)
        {}
    ...
    public:
        ...
        void Apply(const TextProperties::TextColor::ResetColor&) { ModifyReset(); }
    ...
    public:
        bool NeedModif(const TextProperties::TextColor::ResetColor&) { return true; }
    ...
    struct TextPropertiesColorIsApplyType
    {
        ...
        static constexpr bool Value = std::is_same_v<BaseType, TextProperties::TextColor::Color> || std::is_same_v<BaseType, TextProperties::TextColor::ResetColor> ||
