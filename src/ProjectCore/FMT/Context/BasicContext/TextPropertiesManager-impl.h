...
namespace ProjectCore::FMT::Detail
{
    ...
    {
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextColor::Color>(
            index, [this](const TextProperties::TextColor::Color& data) { this->ReloadColor(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextColor::BasicColorFG>(
            index, [this](const TextProperties::TextColor::BasicColorFG& data) { this->AskApplyColor(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextColor::BasicColorBG>(
            index, [this](const TextProperties::TextColor::BasicColorBG& data) { this->AskApplyColor(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextColor::ColorCubeFG>(
            index, [this](const Detail::TextProperties::TextColor::ColorCubeFG& data) { this->AskApplyColor(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextColor::ColorCubeBG>(
            index, [this](const Detail::TextProperties::TextColor::ColorCubeBG& data) { this->AskApplyColor(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextColor::Color24bFG>(
            index, [this](const Detail::TextProperties::TextColor::Color24bFG& data) { this->AskApplyColor(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextColor::Color24bBG>(
    ...
    {
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextFront::Front>(
            index, [this](const TextProperties::TextFront::Front& data) { this->ReloadFront(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextFront::FrontID>(
            index, [this](const TextProperties::TextFront::FrontID& data) { this->AskApplyFront(data); });
    }

    template <typename BasicContext>
    void TextPropertiesManager<BasicContext>::ApplyStyleOnIndex(const FormatIndex& index)
    {
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::Style>(
            index, [this](const TextProperties::TextStyle::Style& data) { this->ReloadStyle(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::Intensity>(
            index, [this](const TextProperties::TextStyle::Intensity& data) { this->AskApplyStyle(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::Italic>(
            index, [this](const TextProperties::TextStyle::Italic& data) { this->AskApplyStyle(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::Underline>(
            index, [this](const TextProperties::TextStyle::Underline& data) { this->AskApplyStyle(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::Blink>(
            index, [this](const TextProperties::TextStyle::Blink& data) { this->AskApplyStyle(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::Inverted>(
            index, [this](const TextProperties::TextStyle::Inverted& data) { this->AskApplyStyle(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::Ideogram>(
            index, [this](const TextProperties::TextStyle::Ideogram& data) { this->AskApplyStyle(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::Script>(
            index, [this](const TextProperties::TextStyle::Script& data) { this->AskApplyStyle(data); });

        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::UnderlineColor::ColorCube>(
            index, [this](const TextProperties::TextStyle::UnderlineColor::ColorCube& data) { this->AskApplyStyle(data); });
        m_Context.GetContextArgsInterface().template RunFuncFromTypeAtIndex<TextProperties::TextStyle::UnderlineColor::Color24b>(
            index, [this](const TextProperties::TextStyle::UnderlineColor::Color24b& data) { this->AskApplyStyle(data); });
    }
    ...
    void TextPropertiesManager<BasicContext>::ParseStyleNamed()
    {
        ...
        static constexpr typename FormatType::template DictPairs<TextProperties::TextStyle::Italic> styleItalic[] = {{"italic", TextProperties::TextStyle::Italic::Enable},
        ...
        static constexpr typename FormatType::template DictPairs<TextProperties::TextStyle::Blink> styleBlink[] = {{"slowblink", TextProperties::TextStyle::Blink::SlowBlink},
        ...
        static constexpr typename FormatType::template DictPairs<TextProperties::TextStyle::Ideogram> styleIdeogram[] = {
            {"i-underlined", TextProperties::TextStyle::Ideogram::Underlined}, {"i-d-underlined", TextProperties::TextStyle::Ideogram::DoubleUnderlined},
            {"i-overlined", TextProperties::TextStyle::Ideogram::Overlined},   {"i-d-overlined", TextProperties::TextStyle::Ideogram::DoubleOverlined},
            {"i-stress", TextProperties::TextStyle::Ideogram::StressMarking},  {"n-i", TextProperties::TextStyle::Ideogram::AllDisable},
        };
    ...
    TextProperties::TextStyle::UnderlineColor::ColorCube TextPropertiesManager<BasicContext>::SelectUnderlinedColorStyle()
    {
        ...
        if (m_BaseContextProperties != nullptr) return m_BaseContextProperties->Style.UnderlineColor.Data.ColorCube;
