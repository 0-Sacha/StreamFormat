...
#define PCP_PROFILE_FUNCTION_FMT(...)                                                                                   \
    ProjectCore::ProfilerManager::ScopeProfile profile##__LINE__(ProjectCore::ProfilerManager::Profiler::GetInstance(), \
                                                                 ProjectCore::ProfilerManager::FMT::FormatString(__VA_ARGS__), "Function")
