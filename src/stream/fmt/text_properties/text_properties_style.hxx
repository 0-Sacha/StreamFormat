...
namespace stream::fmt::detail {
    ...
    struct TextProperties::TextStyle::UnderlineColor::Color24b : public TextProperties::TextColor::BaseColor24b {
        constexpr Color24b(std::uint8_t r = 0, std::uint8_t g = 0, std::uint8_t b = 0) : TextProperties::TextColor::BaseColor24b(r, g, b) {}
    };
    ...
    union TextProperties::TextStyle::UnderlineColor::ColorData {
        constexpr ColorData() : color_cube() {}
    ...
    public:
        ...
        void apply(const TextProperties::TextStyle::reset_style&) {
            modify_reset();
        }
        void apply(const TextProperties::TextStyle::Style& given) {
            *this = given;
        }
        void apply(const TextProperties::TextStyle::Intensity& given) {
            intensity = given;
        }
        void apply(const TextProperties::TextStyle::Italic& given) {
            italic = given;
        }
        void apply(const TextProperties::TextStyle::Underline& given) {
            underline = given;
        }
        void apply(const TextProperties::TextStyle::Blink& given) {
            blink = given;
        }
        void apply(const TextProperties::TextStyle::Inverted& given) {
            inverted = given;
        }
        void apply(const TextProperties::TextStyle::Ideogram& given) {
            ideogram = given;
        }
        void apply(const TextProperties::TextStyle::Script& given) {
            script = given;
        }

        void apply(const TextProperties::TextStyle::UnderlineColor::Color& given) {
            underline_color = given;
        }
    ...
    public:
        bool need_modif(const TextProperties::TextStyle::reset_style&) {
            return true;
        }
        bool need_modif(const TextProperties::TextStyle::Style& given) {
            return *this != given;
        }
        bool need_modif(const TextProperties::TextStyle::Intensity& given) {
            return intensity != given;
        }
        bool need_modif(const TextProperties::TextStyle::Italic& given) {
            return italic != given;
        }
        bool need_modif(const TextProperties::TextStyle::Underline& given) {
            return underline != given;
        }
        bool need_modif(const TextProperties::TextStyle::Blink& given) {
            return blink != given;
        }
        bool need_modif(const TextProperties::TextStyle::Inverted& given) {
            return inverted != given;
        }
        bool need_modif(const TextProperties::TextStyle::Ideogram& given) {
            return ideogram != given;
        }
        bool need_modif(const TextProperties::TextStyle::Script& given) {
            return script != given;
        }

        bool need_modif(const TextProperties::TextStyle::UnderlineColor::Color& given) {
            return underline_color != given;
        }
    ...
    template <typename T>
    concept text_properties_style_can_apply = requires(const T& value, TextProperties::TextStyle::Style& data) { data.apply(value); };
