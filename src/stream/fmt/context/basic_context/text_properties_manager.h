...
namespace stream::fmt::detail
{
    ...
    {
    public:
        TextPropertiesapplyManager(ITextPropertiesExecutor& text_properties_executor)
            : text_properties_executor_{text_properties_executor}
            , current_context_properties_{}
        {}

        [[nodiscard]] std::expected<void, FMTResult> terminate() { return reload_default(); }
    ...
    public:
        detail::TextProperties::Properties save() { return current_context_properties_; }
    ...
    public:
        ...
        [[nodiscard]] std::expected<void, FMTResult> reload_default_color_fg() { return reload_color_fg(detail::TextProperties::TextColor::ColorFG{}); }
        [[nodiscard]] std::expected<void, FMTResult> reload_default_color_bg() { return reload_color_bg(detail::TextProperties::TextColor::ColorBG{}); }
        [[nodiscard]] std::expected<void, FMTResult> reload_default_style() { return reload_style(detail::TextProperties::TextStyle::Style{}); }
        [[nodiscard]] std::expected<void, FMTResult> reload_default_front() { return reload_front(detail::TextProperties::TextFront::Front{}); }
    ...
    public:
        ITextPropertiesExecutor&                    get_text_properties_executor() { return text_properties_executor_; }
        detail::TextProperties::Properties&         get_current_context_properties() { return current_context_properties_; }
    ...
    public:
        ...
        {
            if (current_context_properties_.color.need_modif(modif))
                return apply_color(modif);
            return {};
        }
        template <typename T>
        requires detail::text_properties_style_can_apply<T>
        ...
        {
            if (current_context_properties_.style.need_modif(modif))
                return apply_style(modif);
            return {};
        }
        template <typename T>
        requires detail::text_properties_front_can_apply<T>
        ...
        {
            if (current_context_properties_.front.need_modif(modif))
                return apply_front(modif);
            return {};
        }
        ...
        [[nodiscard]] std::expected<void, FMTResult> ask_apply_color(const detail::TextProperties::TextColor::BasicColor& modif)
        {
            ...
            {
                if (current_context_properties_.color.need_modif(modif.bg))
                    return apply_color(modif);
                return apply_color(modif.fg);
            }
            if (current_context_properties_.color.need_modif(modif.fg))
                return apply_color(modif.bg);
        ...
        [[nodiscard]] std::expected<void, FMTResult> ask_apply_color(const detail::TextProperties::TextColor::ColorFG& modif) { return reload_color_fg(modif); }
        [[nodiscard]] std::expected<void, FMTResult> ask_apply_color(const detail::TextProperties::TextColor::ColorBG& modif) { return reload_color_bg(modif); }
        [[nodiscard]] std::expected<void, FMTResult> ask_apply_color(const detail::TextProperties::TextColor::Color& modif) { return reload_color(modif); }
    };
    ...
    {
    public:
        TextPropertiesManager(ITextPropertiesExecutor& text_properties_executor)
            : TextPropertiesapplyManager(text_properties_executor)
        {}
