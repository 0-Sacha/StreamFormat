...
namespace stream::fmt::detail
{
    ...
    [[nodiscard]] std::expected<void, FMTResult> detail::TextPropertiesManager<TChar>::apply_colorOnIndex(context::BasicContext<TChar>& context, std::int32_t index)
    {
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextColor::Color>(
            index, [this](const detail::TextProperties::TextColor::Color& data) -> std::expected<void, FMTResult> { this->reload_color(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextColor::BasicColorFG>(
            index, [this](const detail::TextProperties::TextColor::BasicColorFG& data) -> std::expected<void, FMTResult> { this->ask_apply_color(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextColor::BasicColorBG>(
            index, [this](const detail::TextProperties::TextColor::BasicColorBG& data) -> std::expected<void, FMTResult> { this->ask_apply_color(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextColor::ColorCubeFG>(
            index, [this](const detail::TextProperties::TextColor::ColorCubeFG& data) -> std::expected<void, FMTResult> { this->ask_apply_color(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextColor::ColorCubeBG>(
            index, [this](const detail::TextProperties::TextColor::ColorCubeBG& data) -> std::expected<void, FMTResult> { this->ask_apply_color(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextColor::Color24bFG>(
            index, [this](const detail::TextProperties::TextColor::Color24bFG& data) -> std::expected<void, FMTResult> { this->ask_apply_color(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextColor::Color24bBG>(
            index, [this](const detail::TextProperties::TextColor::Color24bBG& data) -> std::expected<void, FMTResult> { this->ask_apply_color(data); return {}; }));
        return {};
    }
    ...
    [[nodiscard]] std::expected<void, FMTResult> detail::TextPropertiesManager<TChar>::apply_frontOnIndex(context::BasicContext<TChar>& context, std::int32_t index)
    {
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextFront::Front>(
            index, [this](const detail::TextProperties::TextFront::Front& data) -> std::expected<void, FMTResult> { this->reload_front(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextFront::FrontID>(
            index, [this](const detail::TextProperties::TextFront::FrontID& data) -> std::expected<void, FMTResult> { this->ask_apply_front(data); return {}; }));
        return {};
    }
    ...
    [[nodiscard]] std::expected<void, FMTResult> detail::TextPropertiesManager<TChar>::apply_styleOnIndex(context::BasicContext<TChar>& context, std::int32_t index)
    {
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::Style>(
            index, [this](const detail::TextProperties::TextStyle::Style& data) -> std::expected<void, FMTResult> { return this->reload_style(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::Intensity>(
            index, [this](const detail::TextProperties::TextStyle::Intensity& data) -> std::expected<void, FMTResult> { return this->ask_apply_style(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::Italic>(
            index, [this](const detail::TextProperties::TextStyle::Italic& data) -> std::expected<void, FMTResult> { return this->ask_apply_style(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::Underline>(
            index, [this](const detail::TextProperties::TextStyle::Underline& data) -> std::expected<void, FMTResult> { return this->ask_apply_style(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::Blink>(
            index, [this](const detail::TextProperties::TextStyle::Blink& data) -> std::expected<void, FMTResult> { return this->ask_apply_style(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::Inverted>(
            index, [this](const detail::TextProperties::TextStyle::Inverted& data) -> std::expected<void, FMTResult> { return this->ask_apply_style(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::Ideogram>(
            index, [this](const detail::TextProperties::TextStyle::Ideogram& data) -> std::expected<void, FMTResult> { return this->ask_apply_style(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::Script>(
            index, [this](const detail::TextProperties::TextStyle::Script& data) -> std::expected<void, FMTResult> { return this->ask_apply_style(data); return {}; }));

        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::UnderlineColor::ColorCube>(
            index, [this](const detail::TextProperties::TextStyle::UnderlineColor::ColorCube& data) -> std::expected<void, FMTResult> { this->ask_apply_style(data); return {}; }));
        SF_TRY(context.args_interface.template run_func_from_type_at<detail::TextProperties::TextStyle::UnderlineColor::Color24b>(
            index, [this](const detail::TextProperties::TextStyle::UnderlineColor::Color24b& data) -> std::expected<void, FMTResult> { this->ask_apply_style(data); return {}; }));
        return {};
    }
    ...
    template <typename TChar>
    [[nodiscard]] std::expected<TextProperties::TextStyle::UnderlineColor::ColorCube, FMTResult> TextPropertiesManager<TChar>::select_underlined_color_style(buf::StreamView<TChar>& format)
    {
        // TODO
        // FIXME
