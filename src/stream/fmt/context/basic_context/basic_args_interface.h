...
namespace stream::fmt::detail
{
    ...
    public:
        [[nodiscard]] std::expected<PointerID, FMTResult> get_pointerid_at(std::int32_t) override { return std::unexpected(FMTResult::ArgsInterface_Unavaible); }
        [[nodiscard]] std::expected<PointerID, FMTResult> run_type_at(std::int32_t) override { return std::unexpected(FMTResult::ArgsInterface_Unavaible); }
        [[nodiscard]] std::expected<std::int32_t, FMTResult> get_index_of_current_named_arg(buf::StreamView<TChar>&) override { return std::unexpected(FMTResult::ArgsInterface_Unavaible); }
        [[nodiscard]] std::expected<std::basic_string_view<TChar>, FMTResult> get_string_at(std::int32_t) override { return std::unexpected(FMTResult::ArgsInterface_Unavaible); }
        [[nodiscard]] std::expected<std::int64_t, FMTResult> get_int_at(std::int32_t) override { return std::unexpected(FMTResult::ArgsInterface_Unavaible); }
    };
}
