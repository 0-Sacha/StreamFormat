...
namespace stream::fmt::buf
{
    ...
    public:
        ...
        {
            if (buffer.current_pos + count <= buffer.buffer_end)
                return {};
    ...
    public:
        inline void set(const TChar c) noexcept { *buffer.current_pos = c; }
        ...
        inline void pushback_force(const TChar c) noexcept { *buffer.current_pos++ = c; }
