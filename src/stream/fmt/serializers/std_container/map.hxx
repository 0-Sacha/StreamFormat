...
namespace stream::fmt {
    ...
    struct FormatterType<std::map<T1, T2>, FormatterExecutor> {
        [[nodiscard]] static std::expected<void, FMTResult> format(const std::map<T1, T2>& t, FormatterExecutor& executor) {
    ...
    struct FormatterType<std::multimap<T1, T2>, FormatterExecutor> {
        [[nodiscard]] static std::expected<void, FMTResult> format(const std::multimap<T1, T2>& t, FormatterExecutor& executor) {
